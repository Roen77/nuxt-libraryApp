...
.bookshelf .main_menu{position: fixed; bottom:20%; right:5px;  z-index: 50;  min-width: 160px; z-index: 50; text-align: center;}
.bookshelf .main_menu .sub_menu{padding: 20px; border-radius: 20px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.3); margin-bottom: 20px; background-color: #fff;}
